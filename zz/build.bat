...
set linkerFlags=-luser32 -lvulkan-1 -L%VULKAN_SDK%/Lib -lWs2_32
set definitions=-DZZ_LITTLE_ENDIAN -DZZ_WINDOWS -DZZ_VULKAN -DZZ_DEBUG -DZZ_EXPORT -D_CRT_SECURE_NO_WARNINGS
