...
b8 backend_initialize(const char* application_name, struct platform_application* platform_application)
{
    ...
    dynamic_array_push(required_extension_names, &"VK_KHR_win32_surface");
    ...
    if (!backend_vulkan_context_create_surface(platform_application, &backend_vulkan_context))
    {
...
{
#if defined(ZZ_PLATFORM_WINDOWS)
    struct platform_application_windows_state* state = (struct platform_application_windows_state*)platform_application->state;
