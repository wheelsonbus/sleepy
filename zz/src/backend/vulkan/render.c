...
static struct backend_render backend_render;

b8 backend_render_initialize(struct backend_render_config* config)
{
    backend_render.framebuffer_resized = ZZ_FALSE;
    ...
    memory_array_create_and_reserve(&backend_render.vertices, 1024);
    memory_array_create_and_reserve(&backend_render.indices, 1024);
    ...
    memory_array_create_and_reserve(&backend_render.uniform_buffers, backend_render.sync.max_frames_in_flight);
...
void backend_render_deinitialize()
{
    ...
    memory_array_destroy(&backend_render.uniform_buffers);
    ...
    memory_array_destroy(&backend_render.indices);
    memory_array_destroy(&backend_render.vertices);
}
...
void backend_render_resize()
{
    ...
    {
        backend_render.framebuffer_resized = ZZ_TRUE;
    }
}
...
b8 backend_render_draw_frame()
{
    ...
    memory_array_clear(&backend_render.vertices);
    memory_array_clear(&backend_render.indices);
...
void backend_render_draw_sprite(struct sprite* sprite, vec3 position)
{
    ...
    memory_array_push(&backend_render.vertices, ((struct backend_vulkan_vertex){(vec3){position.x, position.y, position.z}}));
    memory_array_push(&backend_render.vertices, ((struct backend_vulkan_vertex){(vec3){position.x + sprite->size.x, position.y, position.z}}));
    memory_array_push(&backend_render.vertices, ((struct backend_vulkan_vertex){(vec3){position.x + sprite->size.x, position.y + sprite->size.y, position.z}}));
    memory_array_push(&backend_render.vertices, ((struct backend_vulkan_vertex){(vec3){position.x, position.y + sprite->size.y, position.z}}));

    memory_array_push(&backend_render.indices, index + 0);
    memory_array_push(&backend_render.indices, index + 1);
    memory_array_push(&backend_render.indices, index + 2);
    memory_array_push(&backend_render.indices, index + 2);
    memory_array_push(&backend_render.indices, index + 3);
    memory_array_push(&backend_render.indices, index + 0);
}
